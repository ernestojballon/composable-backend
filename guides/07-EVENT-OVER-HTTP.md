...
Please refer to [REST Automation](04-REST-AUTOMATION.md) for details.
<br/>

|                        Previous                          |                   Home                    |                    Next                      |
|:--------------------------------------------------------:|:-----------------------------------------:|:--------------------------------------------:|
| [Platform and PostOffice](06-PLATFORM-AND-POSTOFFICE.md) | [Table of Contents](TABLE-OF-CONTENTS.md) | [Kafka Integration](08-KAFKA-INTEGRATION.md) |
